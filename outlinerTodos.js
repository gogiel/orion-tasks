...
cssNode.innerHTML = ".TodoList {color:#8BA870;font-size:2.5em;font-weight:bold}";
...
headID.appendChild(cssNode);
			...
			_c: {
				"jsl": {
					"ci": {
						...
						"iframes": {
							"additnow": {
								"url": "https://apis.google.com/additnow/additnow.html?bsv\u003dm\u0026abtk\u003dAEIZW7Q%2B8WbWMxD7Qn%2ByFb8CijX/L8HQGpmRpIwQRxyRHn/XtgbiRf%2B78vFgBxhrgbw7jVu/7N8A56P9XarkZMTXgxMuLYrYDTFjGjNgFuRkGG4jTGgPwq8%3D"
							},
							"plus": {
								"methods": ["onauth", "oninvitewidgetclick"],
								"url": ":socialhost:/u/:session_index:/_/pages/badge?bsv\u003dm\u0026abtk\u003dAEIZW7Trr2UijH3EM8IvxG05cl0huDTgqde3DwEhNQY9OGzgsRzjiAMjRVUFIP09Yvx5wdmspTZF42bMqqMNK3hOV7///NvxmNzkQqk/idA/iE1ifWu4oCo%3D"
							},
							...
							"plus_circle": {
								...
								"url": ":socialhost:/:session_prefix:_/widget/plus/circle?bsv\u003dm\u0026abtk\u003dAEIZW7T3XvftwBPqDsh3tkQRqEc71uFat7jqJbxUcbvvKcL7yFRNDFUpefRakCL344i1hG%2B7af6YyDUDeLCa%2BNWupxyH3XL7%2ByR9ON8J9uX6oFR7%2B6W1nBs%3D"
							},
							"evwidget": {
								"params": {
									"url": ""
								},
								"url": ":socialhost:/:session_prefix:_/events/widget?bsv\u003dm\u0026abtk\u003dAEIZW7QLsXaSK87H4gmsCfOSJ4dOCybjgHhPmq5sCkWmtpOjJqZ%2BclI6EVml2M%2B7kEa3nxfLlkdXvgTsKgAG3i9w%2B800TaGMVrxVOaRwfuWJygRjTq2r2cA%3D"
							},
							...
							"plusone": {
								...
								"url": ":socialhost:/:session_prefix:_/+1/fastbutton?bsv\u003dm\u0026abtk\u003dAEIZW7Qu/zlf0rrDY5NLO/SdoUcjiq/gdqmQLeBKnrDEIMCUeUp/7D6bwzTyqRlpgRBDmBg%2B0M5NPM/V527ULfBb7937wabbctEjMvZ6cRs6RuBN5b78ZWg%3D"
							},
							"plus_share": {
								"params": {
									"url": ""
								},
								"url": ":socialhost:/:session_prefix:_/+1/sharebutton?plusShare\u003dtrue\u0026bsv\u003dm\u0026abtk\u003dAEIZW7SjTNuCwF4A/BCLbT2VvknrRWNGk3JIc5ntr447b3ZeQJpe4nSWhFV%2BL0QlLP6SLtbbT/zEM%2BgWoWBTR%2BrR7EP13aeLp9adtEpLSjzjrl92xGoHPw0%3D"
							}
						},
						"debug": {
					...
					"h": "m;/_/apps-static/_/js/gapi/__features__/rt\u003dj/ver\u003d9nCH3HI5kmQ.pl./sv\u003d1/am\u003d!EsUnt3hT0SSIO7F7ug/d\u003d1/rs\u003dAItRSTN3FA8b3ANKcrYC7FM806Xnz8mJgQ",
	...
	function onFetchTodods(lists) {
		console.log('lists')
		console.log(lists);
	}

	var headers = {
		name: "Orion Tasks OUtliner",
		version: "1.0",
	...
	var outlineService = {
		getOutline: function(contents, title) {
			...
			//			} else {
			//				console.log('contents empty sory');
			//			}
			//GoogleTasks.getLists(onFetchTodos);
			...
			$.each(lines, function(idx, val) {
				var matched = val.match(/.*\/\/ TODO(-[0-9])? (.*)/);
				if (matched) todos[idx + 1] = matched[2];
			})
			...
			//var matched = contents.match(/.*\/\/ (-[0-9])? (.*)'/)
			//			console.log(title);			
...
//		var elements = window.parent.document.body.getElementsByClassName('TodoList')
//
//		$.each(elements, function(idx, val) {
//			val.style.color = '#8BA870';
//			val.style['font-size'] = '2.5em'
//			val.style['font-weight'] = 'bold';
//			val.style.border_bottom = '1px solid #ddd';
//		});
		//
		//
